...
/**
 * OutputHtmlRestActionImplTest
 * 
 * @author bose999
 *
 */
public class OutputHtmlRestActionImplTest {

    private static String TEST_DATA = "testData";

    /**
     * getHtml()テスト
     * TemplateUtil が返す文字列が同じになることをテストする
     */
    @Test
    public void testGetHtml() {
        OutputHtmlRestActionImpl outputHtmlRestActionImpl = new OutputHtmlRestActionImpl();
        HttpServletRequestMock request = new HttpServletRequestMock();
        HttpServletResponseMock response = new HttpServletResponseMock();
        outputHtmlRestActionImpl.templateUtil = new TemplateUtilMock();
        String result = outputHtmlRestActionImpl.getHtml(request, response, "");
     ...
     *
     */
    private class TemplateUtilMock extends TemplateUtil {
        public TemplateUtilMock() {
        }
